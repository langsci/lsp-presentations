...
%   \includegraphics[height=.2\textheight]{./path/to/graphicsfile}
  \begin{itemize}
    ...
    \item for more details, see the annotated business model
  \end{itemize}
}
...
\begin{column}{6cm}
  ...
  \end{column}
  \begin{column}{4cm}
    \hspace*{-1cm}\includegraphics[width=6cm]{costtypes2020.png}
  \end{column}
  \end{columns}
...
%   \includegraphics[height=.2\textheight]{./path/to/graphicsfile}
  \begin{itemize}
    ...
    \item we sell about 700 books a year and have about 500k pdf downloads a year (excluding robots)
  \end{itemize}
}
...
%   \includegraphics[height=.2\textheight]{./path/to/graphicsfile}
  \begin{itemize}
    \item project at the Technische Informationsbibliothek (TIB), Hannover
