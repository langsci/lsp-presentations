...
%   \includegraphics[height=.2\textheight]{./path/to/graphicsfile}
  \begin{enumerate}
    \item  Open Science
    \item  Workflow of a scientific manuscript
    \item How can each step in the workflow be made more open?
  \end{enumerate}
}
...
\column{4cm}
  ...
  \end{enumerate}
  \begin{itemize}
    \item $\to$ allow other people to stand on your shoulders
  \end{itemize}

  \column{5cm}
%   \includegraphics[height=.9\textheight]{shouldersofgiants.jpg}
\end{columns}
}
...
%   \includegraphics[height=.2\textheight]{./path/to/graphicsfile}
  \begin{enumerate}
    \item \textbf{gathering of data}
    \begin{itemize}
      \item eg recordings, questionnaires
    \end{itemize}
...
\column{7cm}
  \begin{itemize}
   ...
   \begin{itemize}
    ...
    \item texts
   \end{itemize}
   \item Do \textbf{keep them separate}
      \item allow for \textbf{modular changes}
  \end{itemize}
        \begin{itemize}
    \item the image to the right was created with R, but the data was hard coded in the file.
    \item there are 100 images like that; for each one, the script was changed
    \item $\to$ impossible to recreate the 100 files with legible colours.
  \end{itemize}
...
%   \includegraphics[height=.2\textheight]{./path/to/graphicsfile}
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item H\textit{ow to Share Data and Code when Submitting Papers to a Journal: Practical Questions} \url{https://calc.hypotheses.org/2782}
    \end{itemize}
  \end{itemize}
}
...
%   \includegraphics[height=.2\textheight]{./path/to/graphicsfile}
\begin{itemize}
  \item So your manuscript is accepted with major revisions. What next?
  \begin{itemize}
    \item  \textbf{content revision}: fine-tune argumentation
    \item  \textbf{formal revision}: make sure all guidelines are met and tables and figures look good
...
%   \includegraphics[height=.2\textheight]{./path/to/graphicsfile}
  \begin{itemize}
    ...
    \item   CLOCKSS (\textit{Lots of Copies Keep Stuff Safe}) for legacy publishers
     \item trigger events
    \begin{itemize}
      \item eg bankruptcy
    \end{itemize}
...
%
\frame{
\frametitle{Wrap-up: recommendations}
%   \includegraphics[height=.2\textheight]{./path/to/graphicsfile}
  \begin{itemize}
  \highlight
