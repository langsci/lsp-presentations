...
\title{Open publication of texts, open publication of data}
% \institute{FU Berlin}
\author[Nordhoff]{Sebastian Nordhoff}
\date{Emerging Topics in Typology, Online, 2021-10-27}
...
%     \item Plagiarists
%     \begin{itemize}
%         \item Plagiarists take your work and pretend it is theirs
...
\frame{
\frametitle{Publication of a dissertation}
%   \includegraphics[height=.2\textheight]{./path/to/graphicsfile}
  \begin{itemize}
    \item  legal requirements for publication can often be satisfied via the university document server
    \begin{itemize}
      \item get in touch with your librarian
    \end{itemize}
    \item For ``real'' publication:
    \begin{enumerate}
      \item Research suitable series ({\textasciitilde}6 months before finalization of your manuscript)
      \item Open Access status, fees, readership?
      \begin{itemize}
        \item Who do you want to be read by?
        \item Are you more of a morphologist or more of an Austronesianist?
        \item Check other volumes in the series and see whether their quality and scope match your work
      \end{itemize}
    \item make a shortlist of suitable series
    \item contact the series editors
    \begin{itemize}
      \item ``Dear X, I am about to finish a manuscript on Y and I am considering your series S. Could you tell me whether the topic would be within scope and what the requirements for publication with you would be?''
    \end{itemize}
    \end{enumerate}
  \end{itemize}
}
...
%   \includegraphics[height=.2\textheight]{./path/to/graphicsfile}
  \begin{itemize}
    ...
    \item research suitable series for the publication of your dissertation ahead of time.
  \end{itemize}
}
