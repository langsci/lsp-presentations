...
\begin{columns}
  ...
  \begin{itemize}
       ...
       \pause
       \item    \url{www.menti.com/vnn776iu9o}
       \pause
  \end{itemize}
  \column{4cm}
...
\subsection[ZfS]{Zeitschrift für Sprachwissenschaft}
\frame{
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item         800 EUR sind die Kosten von de Gruyter, gut informierten Kreisen zufolge
       ...
       \item        Immer noch besser als 2\,000 EUR wie im naturwissenschaftlichen Bereich oder 2\,890 USD wie bei Lingua
    \end{itemize}
...
\begin{columns}
  \column{5cm}
  \begin{itemize}
     \item      Formale Schule in der Linguistik stark beeinflusst von \textbf{Noam Chomsky}
...
\column{8cm}
     \begin{itemize}
     \item \textbf{Feldforscherin} Marian Klamer
        \begin{itemize}
        \item \textit{The Alor-Pantar languages}, eins der ersten Bücher bei Language Science Press kam von einem anderen Verlag, da die Herausgeberin wollte, das auch Menschen in Indonesien Zugriff auf das Buch haben können.
            ...
            \end{itemize}
            \end{itemize}
     \item  \textbf{Afrikanist} Larry    Hyman
        \begin{itemize}
            \item  7 Kapitel in 5 LangSci-Büchern, Präsident der Linguistic Society of America
            \item         \textit{I join my many colleagues who seek to produce open-access publications whenever possible.}
            \item          \textit{Open-access is thus a logical extension of how we have always operated. Is it not like this in other fields?}
            \end{itemize}
    \end{itemize}
...
\frametitle{Warum die\\ Sprachwissenschaft?}
    \begin{tabular}{cc}
     \includegraphics[height=3cm]{stefanmueller.jpg}&     \includegraphics[height=3cm]{martinhaspelmath.jpg}\\
...
%   \includegraphics[height=.2\textheight]{./path/to/graphicsfile}
  \begin{itemize}
    ...
    \begin{itemize}
      \item eine Historikerin hätte \textasciitilde{}100 Verlage zur Auswahl, eine Linguistin nur eine Handvoll
    \end{itemize}
...
\section[Community-based]{Community-based Publishing}
\frame{
\frametitle{\mbox{Community-based Publishing:}\\disziplinäre Netzwerke}
%   \includegraphics[height=.2\textheight]{./path/to/graphicsfile}
  \begin{itemize}
       \item   ``Scholar-led'' statt ``shareholder-led''
       \item    Netzwerke
       \begin{itemize}
       ...
       \item            Name Recognition
            \begin{itemize}
                \item \glqq Ah, der ABC Verlag. Da hat doch die XYZ veröffentlicht!\grqq
            \end{itemize}
       \item            Prestige
            \begin{itemize}
                \item \glqq Ich veröffentliche da, wo die Koryphäen meines Fachs veröffentlichen, dann werde ich bestimmt auch eine Koryphäe\grqq
            \end{itemize}
       \end{itemize}
       }

\frame{
\frametitle{\mbox{Community-based Publishing:}\\regionale Netzwerke?}
       \begin{itemize}
...
\frame{
\frametitle{Diszipinäre Netzwerke}
...
%   \includegraphics[height=.2\textheight]{./path/to/graphicsfile}
  \begin{itemize}
    \item Die Linguistik hat verschiedene prestigeträchtige OA-Publikationsorgane
    \begin{itemize}
      \item verschiedene Eigentümerschaft
      \item verschiedene Geschäftsmodelle
    \end{itemize}
     \item Die linguistische Community ist vermutlich ein wesentlicher Faktor für die Verbreitung von OA
     \item Forschungsprojekt im Rahmen der Wissenschaftssoziologie: warum ist das so???
     \item Disziplinäre Community-Ansätze vermutlich vielversprechender als regionale Community-Ansätze
  \end{itemize}
}

\frame{
\frametitle{Vielen Dank nach Hannover!}
\includegraphics[height=\textheight]{diewaldpolitt.png}
}
