...
%   \includegraphics[height=.2\textheight]{./path/to/graphicsfile}
  \begin{itemize}
    ...
    \item The more proofreaders you recruit from your ``own'' field, the closer the proofreading will be to the expectations of ``your'' field
    \begin{itemize}
      \item Master students, PhD candidates
      \item good exposure to the practice of scientific writing
      \item get some exposure to other fields; vary your ``literature diet''.
      \item \url{https://langsci-press.org/user/register} and tick ``proofreader'' box
      \end{itemize}
  \end{itemize}
}
