...
%   \includegraphics[height=.2\textheight]{./path/to/graphicsfile}
  \begin{itemize}
    ...
    \item Gegründet 2014 als DFG-Projekt, ab 2019 mit eigenstängem Geschäftsmodell
    \item Crowdfunding durch ein Konsortium von 100 Bibliotheken und Institutionen weltweit
...
%		\begin{column}{5cm} 
			\begin{center}
				...
				\fbox{Satz durch AutorIn und LSP \raisebox{-0.5mm}{\includegraphics[height=3mm]{img/overleaf.png}}}
