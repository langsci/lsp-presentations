...
\date{7.9.2015 Open Access Tage Zürich\\
\medskip 
This pdf at: \url{http://bit.ly/1VIchoy}
}
...
\begin{itemize}
 ...
 \item 9 veröffentlichte Bücher, >100 Interessensbekundungen, ca. ~16~Ablehnungen
 \item 16 Reihen 
...
\end{itemize} 
      ...
      \frame{ 
\frametitle{\raggedright \mbox{Globaler Nutzen, lokale Kosten}}
...
\frame{ 
\frametitle{\mbox{(staatliche Grundfinanzierung)}}  
\begin{columns}
\column{7cm}
\begin{itemize}
...
\frame{ 
\frametitle{Empirische Evaluation bis 2020} 
\begin{itemize}
...
\begin{itemize}
 ...
 \item Zusammenarbeit mit profitorientierten Dienstleistern, aber:
 \item \textbf{Die Rechtsform sollte auf keinen Fall profitorientiert sein}
  \begin{itemize}
    \item Mehrwert des Verlages: Prestige 
    \item Wenig Elastizität im Prestigemarkt
    \item Hohes Prestige $\to$ beliebige Preise 
    \item Profitorientierte Rechtsformen \textbf{müssen} die Möglichkeiten der Preissetzung ausnutzen
  \end{itemize}
...
\begin{itemize}
 ...
 \item Quellcodes aller Bücher und Softwarebestandteile  sind vollständig auf github zur Nachnutzung verfügbar
 \item Betriebswirtschaftliche Zahlen und Geschäftsprozesse werden in geeigneter Weise  veröffentlicht, sobald diese belastbar vorliegen
 \begin{itemize}
  \item z.\,B.\ heute zur Einsichtnahme nach dem Vortrag
 \end{itemize}
\end{itemize}
% \column{5cm}
% \includegraphics{}
