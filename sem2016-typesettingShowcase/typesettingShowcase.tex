...
\frame{{\tiny\sffamily (from Bergäll 2015)}
\begin{columns}[c]
\begin{column}{62mm}
...
\hfill%
\begin{column}{62mm}
 \resizebox{\textwidth}{!}{\input{im/MeanDegrees.tex}}
\end{column}%
\end{columns}}
...
\hfill%
\begin{column}{60mm}
\centering\resizebox{.45\textwidth}{!}{\input{im/Fan-4-1-starlayout.tex}}\\\vspace{2em}\resizebox{.55\textwidth}{!}{\input{im/Fan-4-3-Corpus-Annotation-Scheme.tex}}
\end{column}%
\end{columns}
\end{frame}
