...
\title{Publishing an \strut accessible grammar}
% \institute{FU Berlin}
\author[Nordhoff]{Sebastian Nordhoff}
\date{ELDP summer school, Berlin, 2023-05-24}
...
%   \includegraphics[height=.2\textheight]{./path/to/graphicsfile}
  \begin{itemize}
    ...
    \item involved in the publication of 200+ books since 2014
  \end{itemize}
}
% 
% \frame{
...
\frame{
\frametitle{\mbox{Where to put your FAIR data?} Repositories}
%   \includegraphics[height=.2\textheight]{./path/to/graphicsfile}
  \begin{itemize}
...
\frame{
\frametitle{Two links for journal articles}
%   \includegraphics[height=.2\textheight]{./path/to/graphicsfile}
  \begin{itemize}
    \item  \url{https://thinkchecksubmit.org}
    \item \url{https://oaling.wordpress.com}
  \end{itemize}
}

\frame{
\frametitle{How to publish a thesis?}
%   \includegraphics[height=.2\textheight]{./path/to/graphicsfile}
  \begin{itemize}
    \item eDoc server
    \item  LOT
...
\frame{
\frametitle{eDoc server}
  \includegraphics[height=\textheight]{edoc2023.png}
}


\frame{
\frametitle{LOT}
  \includegraphics[height=\textheight]{lot2023.png}
}

\frame{
\frametitle{Reader pays: Mouton}
\centering
  \includegraphics[height=\textheight]{mouton2023bookprices.png}
}

\frame{
\frametitle{Author pays: Brill}
  \includegraphics[width=\textwidth]{brill2023bpc.png}
}

\frame{
\frametitle{Author pays: De Gruyter}
  \includegraphics[width=\textwidth]{degruyter2023bpc.png}
}

\frame{
\frametitle{Author pays: Cambridge}
  \includegraphics[width=\textwidth]{cup2023bpc.png}
}


\frame{
\frametitle{Community pays:\\ Langugage Science Press}
...
%   \includegraphics[height=.2\textheight]{./path/to/graphicsfile}
  \begin{itemize}
    \item  separate your data, scripts, and text (+ references)
...
%   \includegraphics[height=.2\textheight]{./path/to/graphicsfile}
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \begin{itemize}
        \item also LSA Bloomfield Book Award 2023
      \end{itemize}
...
\frame{
\frametitle{von der Gabelentz Award\strut\\ for Christian Döhler}
\fbox{
  \includegraphics[width=\textwidth]{gabelentzAwardDoehlerOA.png}
  }
}


\frame{
\frametitle{Language Science Press and Open Science}
  \begin{itemize}
    \item all component files are available for all books so that future authors can see how a particular example/graph/image was created
    \item content available on many different platforms
    \item extraction of references for Glottolog.org
    \item extraction of examples to IMTVault.org
  \end{itemize}
}
...
\fbox{
  \includegraphics[width=\textwidth]{glottologrefs.png}
  }
}
...
\frametitle{IMTVault}
\fbox{
  \includegraphics[width=\textwidth]{imtvault.png}
  }
}


\frame{
\frametitle{How to submit to Language Science Press}
%   \includegraphics[height=.2\textheight]{./path/to/graphicsfile}
  \begin{itemize}
    \item  all books have to appear in a series (e.g. \textit{Comprehensive Grammar Library} or \textit{Languages of the Caucasus})
    \item initial submission can be in any format
    \item revised version must be in \LaTeX{}
    \item templates and support are available
    \item conversion
    \begin{itemize}
      \item templates + respect for guidelines + citation manager $\to$ easy
      \item random format + manual citations $\to$ painful
    \end{itemize}
  \end{itemize}
}
...
\frame{
\frametitle{Demo}
  \includegraphics[height=\textheight]{overleaf.png}
}
