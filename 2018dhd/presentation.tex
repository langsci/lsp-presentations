...
\title{\mbox{Übergang vom Communiy-Projekt} \mbox{zum tragfähigen Geschäftsmodell}}
% \institute{FU Berlin}
...
\begin{itemize}
 ...
 \item \Huge Consortia\pause\\
 \large Printmarge \pause \\
 \normalsize Autorengebühren\pause \\
 \tiny Spenden,\pause\\
 Mitgliedschaften  
\end{itemize}
}
...
\begin{itemize}
 ...
 \begin{itemize}
  ...
  \item ???
 \end{itemize}
 \item Organsisation und Struktur des Erwerbs in Bibliotheken
\end{itemize}
}
