...
\hfill\includegraphics[width=2.2cm]{payne}
\hfill\includegraphics[width=2.2cm]{torrence}
\hfill\includegraphics[width=2.2cm]{Persohn} 
\hfill\includegraphics[width=2.2cm]{schrock}
\hfill\\                   %  .2
\hfill\includegraphics[width=2.2cm]{brindle}
\hfill\includegraphics[width=2.2cm]{Friesen}
\hfill\includegraphics[width=2.2cm]{roettger}
\hfill\includegraphics[width=2.2cm]{stenzel}
}
...
\begin{itemize}
 ...
 \begin{itemize}
  ...
  \end{itemize}
  \item Diamant/Platin-Weg: Community-based publishing
  \begin{itemize}
...
\begin{itemize}
 ...
 \end{itemize}
 \item Schritte zur Lösung:
 \begin{itemize}
  \item Aufbau neuer Marken
...
\frame{ 
\frametitle{Community: \mbox{Post Publication Comments}}
...
\pause
\begin{itemize}
 \item kalkulatorische Kosten für ein Buch in Jahr 5: 8.186,77 EUR
\end{itemize}
}
...
\begin{itemize}
 ...
 \item Stand heute: 22 Bücher veröffentlicht, bis Ende Dezember 30
