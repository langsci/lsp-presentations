...
\frametitle{Sri Lanka Malay}
 \begin{itemize}
    ...
    \item \citet{Hussainmiya1990,Nordhoff2009,Nordhoff2012ed}
  \end{itemize}
}
...
\frame{
\frametitle{Regular sound change: Vowel lengthening{\slash}gemination}
 \begin{itemize}
...
\frametitle{Cover-up beyond\\ vowel lengthening}
 \begin{itemize}
    ...
    \item  syllabification of ŋ
    \item  heterosyllabic N\textsubwedge{C} clusters
...
\frametitle{Fronting of d}
 \begin{itemize}
    ...
    \begin{itemize}
      \item \textit{ade}  $\to$ \textit{aade} `younger sibling'
    \end{itemize}
    \item exception:
    \begin{itemize}
...
\frametitle{Metalinguistic awareness}
 \begin{itemize}
    ...
    \item would the word for `earth' be {\sffamily   බුමි} (short vowel) or {\sffamily   බූමි} (long vowel)?
    \begin{itemize}
      \item ``No, you can't write like that, it has to be {\sffamily   භූමි}{}'' (bh\=umi, aspirated bh, long vowel) (Sinhala has a cognate word written {\sffamily   භූම} <bhuuma>, pronounced [buumə])
    \end{itemize}
    \end{itemize}
    }
...
\frametitle{Metalinguistic awareness}
 \begin{itemize}
    ...
    \begin{itemize}
      \item NB: In distinction to many other IA languages, Sinhala has no contrast in aspiration
    \end{itemize}
...
\frametitle{Summary}
 \begin{itemize}
    ...
    \begin{enumerate}
      \item regemination (\textit{kappal})
      \item de-resyllabification of ŋ (\textit{siŋ.ga})
      \item tautosyllabic N\textsubwedge{C} clusters (\textit{gaa.mbar})
      \item re-fronting of voiced coronal stop (\textit{kal\textsubbridge{d}e})
    \end{enumerate}

    \item New undescribed type of language change
