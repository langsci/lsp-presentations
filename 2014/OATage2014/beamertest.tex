...
% \institute{FU Berlin}
\author[\parbox{1cm}{Nordhoff\newline Siller}]{Sebastian Nordhoff \& Debora Siller}
...
\begin{itemize}
\item Juni 2012 Treffen mit Adele Goldberg, Thomas Herbst, Anatol Stefanowitsch
...
\item September 2014 40 Anfragen, 14 angenommene Bücher, 2 veröffentlichte Bücher
\end{itemize}
}
...
\parbox{.3\textwidth}{\includegraphics[width=.3\textwidth]{pics/schwaengma.png}}
 \end{itemize}
\end{itemize}
}
...
\end{column}
\begin{column}{4cm}
 \parbox{4cm}{\includegraphics[width=4cm]{pics/reihen.png}\vspace{2cm}}
\end{column}
\end{columns}
...
\item proaktive Gestaltung der Dienstleistungslandschaft
    ...
    \parbox{2cm}{\includegraphics[width=1cm]{pics/cidleslogo.png}}
