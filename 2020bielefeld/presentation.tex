...
\begin{itemize}
 ...
 \item alle Bücher Open Access (CC-BY 4.0)
 ...
 \item Finanziert durch Konsortial-Modell von Bibliotheken und Wissenschaftlichen Gesellschaften
\end{itemize}
}
...
\centering
\begin{tabular}{ll}
\bfseries Wiss. Community & \bfseries Ext. Verlage\\\midrule
...
\centering
\begin{tabular}{ll}
\multicolumn{2}{c}{\bfseries Wiss. Community}\\\midrule
  Konzipieren   &    Korrektorat       \\
  Forschen      &    Satz              \\
  Schreiben     &    Druck             \\
  Formatieren   &    Vertrieb          \\
