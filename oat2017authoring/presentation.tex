...
\title{Open Authoring}
% \institute{FU Berlin}
\author[LangSci]{Sebastian Nordhoff @langscipress}
...
\includegraphics[width=2.5cm]{starofficelogo.png}~$\to$
\includegraphics[width=4cm]{openofficelogo.png}~$\to$
...
\parbox{7cm}{Das BMBF fördert über den Prototypefund das Projekt docLoop-OER mit 30.000 EUR

\url{https://rhotep.github.io/docLoop/}
}
