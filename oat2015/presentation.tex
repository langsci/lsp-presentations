...
\begin{tabular}{lll}
 \onslide<1-7> Autoren  & $\to$ &  \onslide<2-7>Sichtbarkeit\\
 \onslide<1-7> Leser  & $\to$ &  \onslide<3-7>Zugang, Nachnutzung, Karma \\
...
\end{itemize} 
\column{5cm}
\includegraphics[width=4cm]{pics/loc.jpg}
\end{columns} 
}
...
https://commons.wikimedia.org/wiki/File:Melik_Ohanian_Futuring\_\%28Planet\%29_2011.jpg
\end{itemize}
